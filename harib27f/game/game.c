...
check:
	...
	case 30:
		...
		theOne = theOther;
		theOther = temp2;
		sprintf(note, "change position! Enter to continue..\0");
		break;
	case 3:
	case 12:
	case 32:
	...
	case 60:
		...
		sprintf(note, "go 5 block！Enter to continue..\0");
		break;
	case 6:
	case 33:
	case 41:
	...
	case 64:
		...
		sprintf(note, "back 5 block！Enter to continue..\0");
		break;
	default:
		sprintf(note, "go %d block！Enter to continue..\0", temp1);
		break;
	}
...
win:
	if (flag == 1) {
		sprintf(note, "femail win！Enter to continue..\0");
	}
	else {
		sprintf(note, "male win！Enter to continue..\0");
	}
